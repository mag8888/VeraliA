...
ВАЖНО: Если данные о подписчиках или публикациях не указаны (показано "не указано" или "неизвестно"), это означает, что:
- Либо профиль приватный и данные недоступны
- Либо произошла ошибка при получении данных
- Либо профиль новый/неактивный

В этом случае проанализируй аккаунт на основе:
- Биографии профиля (это ключевой источник информации о нише и тематике)
- Username (может указывать на тематику)
- Общего контекста Instagram аккаунта

Дай общую оценку аккаунта на основе доступной информации и предположи его потенциал. Если данных недостаточно, укажи это в отчете, но все равно проведи анализ на основе того, что доступно."""
